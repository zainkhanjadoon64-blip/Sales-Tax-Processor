      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
        <div className="w-full max-w-md text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <Link
              to="/login"
              className="inline-flex items-center justify-center w-full h-12 rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold text-sm hover:from-blue-700 hover:to-blue-800 transition-all"
            >
              Return to Login
            </Link>
          </div>
          ...
          <div className="relative z-10 flex flex-col justify-between w-full p-10 xl:p-14">
            ...
            <div className="flex-1 flex flex-col justify-start max-w-lg mt-6">
              <h1 className="text-4xl xl:text-5xl font-bold text-white leading-[1.15] mb-5">
                Start Your <span className="text-blue-200">Journey.</span>
                <br />
                Join <span className="text-blue-200">Tax Suite.</span>
              </h1>
              <p className="text-blue-200/80 text-base leading-relaxed mb-8">
                Create your account and unlock the power of automated tax management.
              </p>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-white relative overflow-y-auto">
          ...
          <div className="w-full max-w-md py-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-gray-500 mt-1.5">Fill in your details to get started</p>
            </div>
              ...
              <div className="flex items-start gap-2">
                <div className="relative mt-0.5">
                  ...
                  <div
                    ...
                    className="w-4 h-4 rounded border border-gray-300 bg-white peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-all flex items-center justify-center cursor-pointer"
                  >
                    {agreeTerms && (
                ...
                <label htmlFor="terms" className="text-sm text-gray-500 cursor-pointer select-none">
                  I agree to the{' '}
                  <a href="#" className="font-medium text-blue-600 hover:text-blue-700 transition-colors">Terms of Service</a>
                  {' '}and{' '}
                  <a href="#" className="font-medium text-blue-600 hover:text-blue-700 transition-colors">Privacy Policy</a>
                </label>
              </div>
